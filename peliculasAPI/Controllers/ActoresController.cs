...
namespace peliculasAPI.Controllers
{
	...
	{
		public readonly AplicationDbContex context;
		private readonly IMapper mapper;
		private readonly IAlmacenadorArchivo almacenadorArchivos;
		private readonly string contenedor = "actores";

		public ActoresController(AplicationDbContex context,IMapper mapper,
			IAlmacenadorArchivo almacenadorArchivos)
		{
		...
		public async Task<ActionResult> Put(int id,[FromForm] ActorCreacionDTO actorCreacionDTO)
		{
			...
			if(actorCreacionDTO.Foto != null)
			{
				//pasamos la nueva foto para actualizar
